...
class ResEncoder(nn.Module):
    def __init__(self): #, enc_size):
        ...
        self.in_conv = self.resnet.conv1
        self.in_bn = self.resnet.bn1
        self.in_relu = self.resnet.relu
        self.in_maxpool = self.resnet.maxpool
        
        self.layers = nn.ModuleList([self.resnet.layer1, self.resnet.layer2, self.resnet.layer3, self.resnet.layer4])        
